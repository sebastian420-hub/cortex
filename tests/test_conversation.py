...
def test_conversation_manager():
    ...
    manager = ConversationManager(
        system_prompt="You are a helpful assistant.", max_tokens=1000, keep_recent=5
    )
...
def test_conversation_clear():
    ...
    manager = ConversationManager(system_prompt="You are a helpful assistant.", max_tokens=1000)
