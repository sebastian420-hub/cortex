...
class ASTAnalyzeTool(Tool):
    ...
    def execute(
        ...
        for file_path in files:
            ...
            file_analysis = self._analyze_file(
                file_path, language, analysis_type,
                max_depth, include_metrics,
                include_dependencies, include_issues
            )
    ...
    def _calculate_file_metrics(self, file_path: Path, language: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Complexity metrics
            metrics["cyclomatic_complexity"] = self._estimate_cyclomatic_complexity(content, language)
    ...
    def _analyze_dependencies(self, file_path: Path, language: str, max_depth: int) -> Dict[str, Any]:
        """
