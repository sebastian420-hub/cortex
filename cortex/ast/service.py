...
class ASTService:
    ...
    def __init__(self, cache_size: int = 100, enable_cache: bool = True):
        ...
        logger.info(f"AST Service initialized with cache_size={cache_size}, enable_cache={enable_cache}")
    
    def parse_file(self, file_path: Union[str, Path], language: Optional[str] = None) -> Optional[Any]:
        """
    ...
    def extract_functions(self, file_path: Union[str, Path], language: Optional[str] = None) -> List[FunctionInfo]:
        """
    ...
    def extract_classes(self, file_path: Union[str, Path], language: Optional[str] = None) -> List[ClassInfo]:
        """
    ...
    def extract_imports(self, file_path: Union[str, Path], language: Optional[str] = None) -> List[ImportInfo]:
        """
    ...
    def find_symbol(self, file_path: Union[str, Path], symbol: str, 
                   language: Optional[str] = None) -> List[Tuple[int, int]]:
        """
    ...
    def query(self, file_path: Union[str, Path], query_pattern: str, 
    ...
    def get_function_at_position(self, file_path: Union[str, Path], line: int, column: int,
                               language: Optional[str] = None) -> Optional[FunctionInfo]:
        """
    ...
    def get_code_block(self, file_path: Union[str, Path], start_line: int, end_line: int,
        ...
        try:
            ...
            if min_indent < float('inf'):
                block_lines = [line[min_indent:] if len(line) >= min_indent else line 
                             for line in block_lines]
