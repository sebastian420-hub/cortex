...
class EnhancedProviderFactory:
    ...
    def _load_default_config(self) -> None:
        ...
        self.provider_configs[ProviderType.OLLAMA] = ProviderConfig(
            ...
            aliases={"llama": "llama3.2", "deepseek-r1": "deepseek-r1:8b", "qwen": "qwen2.5:32b"},
        )
    ...
    def get_provider(
        self, model_name: str, provider_override: Optional[str] = None
    ) -> ModelProvider:
        """
        ...
        if not self._is_provider_enabled(provider_type):
            ...
            if fallback:
                ...
                raise ProviderError(
                    f"Provider {provider_type.value} is disabled and no fallback available"
                )
    ...
    def register_provider(
        self, provider_type: ProviderType, provider_class: Type[ModelProvider]
    ) -> None:
        """
