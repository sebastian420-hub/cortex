...
class RoutingOrchestrator:
        ...
        try:
            ...
            decision = RoutingDecision(
                ...
                decision_source=(
                    ...
                    if force_provider or force_model
                ...
                confidence_score=(task_analysis.confidence if task_analysis else 0.5),
                metadata={
            ...
            return self._create_fallback_decision(user_request, context, request_id, str(e))
    ...
    def _select_model(
        ...
        """
        reasoning = {"primary_reason": "", "secondary_reasons": [], "factors": {}}
    ...
    def _select_model_for_task(
        self, task_analysis: Optional[TaskAnalysis], provider_type: ProviderType
    ) -> str:
        """
        ...
        if provider_type == ProviderType.OLLAMA:
            ...
            if task_analysis:
                ...
                elif task_analysis.task_type in [
                    TaskType.CODING,
                    TaskType.DEBUGGING,
    ...
    def _estimate_cost(
        ...
        try:
            ...
            if cost_estimate:
                ...
                if (
                    self.config.warn_on_high_cost
                    and cost_estimate.estimated_cost_usd > self.config.high_cost_threshold
                ):
                    logger.warning(
    ...
    def _build_routing_reasoning(
        ...
        if cost_estimate:
            if cost_estimate.estimated_cost_usd == 0:
                ...
                reasoning.cost_consideration = (
                    f"Moderate cost (${cost_estimate.estimated_cost_usd:.4f})"
                )
            else:
                reasoning.cost_consideration = (
                    f"Higher cost (${cost_estimate.estimated_cost_usd:.4f})"
                )

        return reasoning

    def _generate_cache_key(self, user_request: str, context: Optional[RoutingContext]) -> str:
        """
    ...
    def _create_fallback_decision(
        ...
        return RoutingDecision(
            ...
            metadata={"request_id": request_id, "error": error_message, "is_fallback": True},
        )
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        if stats["total_requests"] > 0:
            ...
            stats["avg_routing_time_ms"] = stats["routing_time_ms"] / stats["total_requests"]
