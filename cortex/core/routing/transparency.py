...
class DecisionLogger:
    ...
    def get_decisions_by_task_type(self, task_type: TaskType) -> List[RoutingDecision]:
        ...
        return [
            ...
            if d.task_analysis and d.task_analysis.task_type == task_type
        ]
    ...
    def get_decision_stats(self) -> Dict[str, Any]:
        ...
        for decision in self.decisions:
            ...
            provider_counts[decision.provider_name] = provider_counts.get(decision.provider_name, 0) + 1
            source_counts[decision.decision_source.value] = source_counts.get(decision.decision_source.value, 0) + 1
...
class TransparencyDisplay:
    ...
    def _format_text(self, decision: RoutingDecision) -> str:
        ...
        provider_info = self.provider_display.get(
            ...
            {"name": decision.provider_name, "icon": "🤖", "color": "white"}
        )
        ...
        if decision.task_analysis:
            task_display = self.task_type_display.get(
                decision.task_analysis.task_type,
                decision.task_analysis.task_type.value
            )
