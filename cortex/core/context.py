...
def truncate_history(
    ...
    total_tokens = sum(
        estimate_tokens(json.dumps(msg, default=str), model) for msg in conversation_history
    )
...
def get_conversation_tokens(
    ...
    Returns:
        Estimated token count
    """
    return sum(estimate_tokens(json.dumps(msg, default=str), model) for msg in conversation_history)
